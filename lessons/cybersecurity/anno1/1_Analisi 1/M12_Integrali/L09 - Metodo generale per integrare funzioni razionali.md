...
\deg(P)\ge \deg(Q)
$$
Cioè se il numeratore ha grado maggiore o uguale al denominatore.
...
- $S(x)$ è il quoziente (polinomio)
    
- $R(x)$ è il resto (con grado **minore** di $Q$)    
...
Scrivi la frazione come **somma** di frazioni più semplici.  
