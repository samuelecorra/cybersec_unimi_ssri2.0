...
La procedura generale resta la stessa (4 step), ma cambia **lo step 3**, cioè **come scrivi la decomposizione**.
...
**“Il denominatore è un fattore lineare semplice?”**
→ numeratore: costante.

**“È un fattore lineare ripetuto?”**
→ più frazioni, una per ogni potenza.

**“È un fattore quadratico irriducibile?”**
