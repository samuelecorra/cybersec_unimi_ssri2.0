...
public class IntroOOP {
    ...
    // È un'evoluzione della programmazione imperativa (procedurale) che gettava
    // le sue radici nel C e ancor prima nel Fortran.

    // Nella programmazione imperativa il programma è visto come una sequenza
    ...
    // Nella programmazione orientata agli oggetti, invece, il programma è visto
    // come un insieme di oggetti che interagiscono tra loro per risolvere un
    // problema.

    // Un oggetto è un'entità che incapsula dati (attributi) e comportamenti
    ...
    // - Modularità: il codice è organizzato in moduli (classi) che possono essere
    //   sviluppati, testati e mantenuti in modo indipendente.
    // - Riutilizzabilità: le classi possono essere riutilizzate in diversi progetti,
    //   riducendo la duplicazione del codice.
    // - Manutenibilità: il codice è più facile da comprendere e modificare grazie
    ...
    // - Ereditarietà: le classi possono ereditare attributi e metodi da altre classi,
    ...
    //   classe comune, permettendo di scrivere codice più flessibile e generico.
    ...
    public static void main(String[] args) {
        ...
        // Se la classe non ridefinisce toString(), println usa Object.toString().
        System.out.println(p1); // L'output appare come
        // M09_OOP.L01_IntroOOP.Principessa@8efb846 (o simile): nome della classe,
        // simbolo @ e hash code in esadecimale. Non è un indirizzo di memoria.
        // Approfondiremo meglio ma per ora
