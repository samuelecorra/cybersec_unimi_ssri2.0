...
| -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `prepare`                        | Alcuni RM potrebbero essere bloccati. Il TM può:<br>1️⃣ Scrivere `global abort` e completare la seconda fase, **oppure**<br>2️⃣ Ripetere la prima fase del protocollo. |
| `global commit` / `global abort` | Alcuni RM potrebbero aver ricevuto la decisione, altri no. Il TM deve **ripetere la seconda fase** per notificare tutti.                                             |
