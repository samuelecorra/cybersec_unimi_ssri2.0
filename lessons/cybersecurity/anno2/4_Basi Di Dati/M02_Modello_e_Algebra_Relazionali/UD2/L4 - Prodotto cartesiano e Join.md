...
Invocando il theta-join con condizione di uguaglianza tra gli attributi Aula e Nome, che qui ricordiamo essere commutativo:

$$
CORSI \bowtie_{\text{Aula = Nome}} AULE == AULE \bowtie_{\text{Nome = Aula}} CORSI
$$

N.B.: Otteniamo 2 tuple sulle 4 totali del prosotto cartesiano, perché solo 2 soddisfano la condizione.
...
$$
(STUDENTI \bowtie_{\text{Matr = Stud}} ESAMI)
\bowtie_{\text{Esame = Codice}}
CORSI
$$

Risultato:

| Matr  | Cognome | Stud  | Esame | Codice | Titolo   |
| ----- | ------- | ----- | ----- | ------ | -------- |
| 11111 | Bianchi | 11111 | CS101 | CS101  | Basidati |
| 22222 | Rossi   | 22222 | CS102 | CS102  | Sistemi  |
| 33333 | Verdi   | 33333 | CS101 | CS101  | Basidati |
...
$$
r_1 \bowtie r_2 = \pi_{A,B,C,D} \big( r1 \bowtie_{B=B' \land C=C'} (\rho_{B'C' \leftarrow BC}(r_2)) \big)
$$
