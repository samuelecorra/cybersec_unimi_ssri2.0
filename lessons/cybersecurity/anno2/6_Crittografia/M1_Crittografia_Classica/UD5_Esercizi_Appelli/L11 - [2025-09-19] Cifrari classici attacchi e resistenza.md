...
L'avversario può scegliere testi cifrati arbitrari e ottenere i corrispondenti testi in chiaro decifrati (accesso a un oracolo di decifratura). È il modello di attacco più forte. Attenzione: a primo impatto una
definizione simile potrebbe far pensare che allora l'opponent ha accesso a ogni tipo di decrittazione, ma poter decrittare ciò che vuole non significa avwew
