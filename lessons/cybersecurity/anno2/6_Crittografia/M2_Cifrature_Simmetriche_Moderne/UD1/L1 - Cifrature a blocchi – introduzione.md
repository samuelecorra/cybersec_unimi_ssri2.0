...
La lunghezza della chiave per una cifratura generica di blocchi da $n$ bit coincide con la dimensione
della colonna della tabella: la colonna è "alta" $2^n$ righe, ognuna con un blocco cifrato di $n$ bit, quindi la chiave è lunga:
