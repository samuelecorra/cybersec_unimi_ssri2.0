...
- se è presente nell’ultima colonna, si verifica la corrispondenza con $DES_{X(i,t-1)}(x)$, ovvero con il risultato della cifratura DES con la chiave che corrisponde alla voce nella colonna sulla sinistra dell’ultima colonna, e se c’è corrispondenza, abbiamo trovato la chiave;
- se è presente nell'ultima colonna ma non c'è corrispondenza, vuol dire
