...
**Condizione:** $\gcd(e_1, e_2) = 1$ (quasi sempre vera se $e_1, e_2$ sono scelti come numeri primi distinti).
...
Poiché $\gcd(e_1, e_2) = 1$, per l'identità di Bézout esistono interi $x, y$ (con uno eventualmente negativo) tali che:
