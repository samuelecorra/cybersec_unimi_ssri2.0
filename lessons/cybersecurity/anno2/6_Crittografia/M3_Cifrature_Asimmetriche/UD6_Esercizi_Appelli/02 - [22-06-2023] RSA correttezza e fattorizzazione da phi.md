...
Setup: $n = pq$ ($p,q$ primi distinti), $\varphi(n) = (p-1)(q-1)$, esponente pubblico $e$ con $\mcd(e,\varphi(n))=1$, esponente privato $d \equiv e^{-1} \pmod{\varphi(n)}$. Cifratura $c = m^e \bmod n$, decifratura $m' = c^d \bmod n$. Va dimostrato $m' = m$.
