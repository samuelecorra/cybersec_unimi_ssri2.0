...
- La chiave è una matrice $K$ di dimensione $m \times m$ con coefficienti in $\mathbb{Z}_{26}$, tale che $K$ sia invertibile in $\mathbb{Z}_{26}$ (cioè $\operatorname{mcd}(\det K, 26) = 1$).
...
Poiché $\det K = 1$ e $\operatorname{mcd}(1, 26) = 1$, la matrice è invertibile in $\mathbb{Z}_{26}$.
...
**Consigli pratici:**
- Per Hill: verificare sempre il determinante prima di calcolare $K^{-1}$. Se $\det K = 0$ o $\operatorname{mcd}(\det K, 26) \neq 1$, la chiave non è valida.
