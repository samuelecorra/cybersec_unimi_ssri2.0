...
- Identificare gli **operatori elementari** per la manipolazione dei dati gerarchici
...
Se le strutture lineari rappresentano **sequenze** di elementi collegati in una sola direzione, gli alberi modellano **relazioni di dipendenza** e **ramificazioni**, come quelle che troviamo nella realtà:
...
Dal punto di vista logico, gli alberi sono fondamentali per:

- organizzare **grandi quantità di dati** in modo efficiente;
...
1. definire formalmente la struttura di un albero;
    
2. esplorare i diversi **modi di rappresentarlo** (liste di figli, puntatori, vettori);
