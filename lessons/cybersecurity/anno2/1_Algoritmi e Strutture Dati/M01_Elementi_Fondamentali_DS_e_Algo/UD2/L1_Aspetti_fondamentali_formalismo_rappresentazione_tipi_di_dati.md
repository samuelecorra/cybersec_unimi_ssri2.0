...
Le precondizioni, se presenti, sono _quasi_ sempre la validità degli indici, come qui si può notare...
...
che essenzialmente significa che dopo aver scritto `e` nella posizione `i`, tutti gli altri elementi del vettore restano invariati.
