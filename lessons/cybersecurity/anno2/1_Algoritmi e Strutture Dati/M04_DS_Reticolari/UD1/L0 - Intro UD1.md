...
Ogni grafo nasce dal bisogno di **rappresentare connessioni**, non semplici sequenze o gerarchie.

Un **grafo** è formato da **nodi (o vertici)** e da **archi (o spigoli)** che collegano le coppie di nodi.  
A seconda della direzione degli archi e del modo in cui li rappresentiamo, possiamo ottenere grafi **orientati**, **non orientati**, **pesati**, **connessi**, e così via.

Nel corso di questa unità didattica impareremo a:

- comprendere **come sono organizzate le informazioni** all’interno di un grafo;
    
- riconoscere **i contesti reali** in cui i grafi offrono la rappresentazione più efficace (reti, percorsi, dipendenze, priorità, ecc.);
